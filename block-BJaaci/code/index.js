...
movies[0],movies[1],movies[2].year>2017?true:false;
// 23. Log the title of all three movies one by one.
movies[0].title,movies[1].title,movies[2].title
...
movies[0].actors,movies[1].actors,movies[2].actors
// 26. Log the number of genres in all three movies one by one
movies[0].genres,movies[1].genres,movies[2].genres
// 27. Log the name of all the movies with more than 1 genre
movies[0].genres[0], genres[1]
movies[1].genres[0], genres[1]
movies[2].genres[0], genres[1]
// 28. Log the name of all the movies with more than 1 actors
movies[0].actors[0], actors[1]
movies[1].actors[0], actors[1]
movies[2].actors[0], actors[1]
// 29. Log the name of all the movies with exactly 3 actors
movies[0].actors,movies[1].actors,movies[2].actors
// 30. Log the name of all the movies with year `2018`
movies[0].year,movies[1].year