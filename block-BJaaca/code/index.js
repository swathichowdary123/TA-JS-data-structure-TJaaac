...
let greet=function(){
    alert(`I am ${character1} and my title is ${title}`);
}
...
let greet1=function(){
    alert(`she is ${character1} and her title is ${title}`);
}
...
characterObject.isAdult=true?"age is greater than 18":"it will false";
